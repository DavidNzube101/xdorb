              ...
              {isLoading ? (
                ...
                <div className="space-y-2">
                  {pnodes?.map((node) => (
                    <div
                      key={node.id}
                      className="flex items-center gap-4 p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer bg-muted/30"
                    ...
                    >
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <div className="space-y-1">
                            ...
                            <p className="text-sm">Last Seen: {new Date(node.lastSeen * 1000).toLocaleString()}</p>
                          </div>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2 mt-1">
                          ...
                          <Badge variant="outline" className="text-xs">
                            Last seen: {new Date(node.lastSeen * 1000).toLocaleDateString()}
                          </Badge>
                        </div>
                      </div>
